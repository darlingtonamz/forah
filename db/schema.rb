...
ActiveRecord::Schema.define(version: 20160105213956) do
  ...
  add_index "assemblies_parts", ["category_id"], name: "index_assemblies_parts_on_category_id"
  add_index "assemblies_parts", ["post_id"], name: "index_assemblies_parts_on_post_id"
